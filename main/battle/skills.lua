...
local skillData = {
	...
	[M.BERSERK]      = { cost=70, damage = 0, cooldown = 60, globalCoolDown = 0, castTime = 0 },
	...
	[M.FROST_BOLT_CAST]   = { cost=40, damage = 2, cooldown = 8, globalCoolDown = 0.5, castTime = 2.5 },
	...
	[M.ROCKET_BIG] = {cost = 0, damage = 4, cooldown = 1, globalCoolDown = 0, castTime = 2.5},
}
